...
describe('GuestController', () => {
      ...
      providers: [
        {
          ...
          useValue: {
            ...
            deleteGuestAccount: jest
              .fn()
              .mockReturnValue('Account deleted succesessfully'),
          },
        },
        PrismaService,
        JwtService,
  ...
  describe('getAccountInfo', () => {
    ...
    it('Should return guest account info correctly', async () => {
      const mockGuestAccInfoResponse = jest
        .fn()
        .mockReturnValue(mockGuestAccInfo);
      jest
        .spyOn(guestService, 'getAccountInfo')
        .mockImplementation(mockGuestAccInfoResponse);
    ...
    it('Should throw unauthorized exception if has no guest', async () => {
      const guest = null;
      expect(() => {
        controller.getAccountInfo(guest);
  ...
  describe('getUserReservations', () => {
    it('Should get all guest reservations', async () => {
      ...
      jest
        .spyOn(guestService, 'getGuestReservations')
        .mockImplementation(mockGuestReservationsResponse);
  ...
  describe('updateGuestInfo', () => {
    ...
    it('Should update guest info with correct params', async () => {
      ...
      jest
        .spyOn(guestService, 'updateGuestInfo')
        .mockImplementation(mockUpdateGuestInfo);
  ...
  describe('deleteGuestAccount', () => {
    it('Should throw Unauthorized exception if has no guest', async () => {
      const guest = null;
      expect(() => {
        controller.DeleteGuestAccount(guest);
      }).toThrowError(UnauthorizedException);
    });
  });
});
